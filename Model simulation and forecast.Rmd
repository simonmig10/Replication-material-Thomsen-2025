...
Endo_model <- 'model endo 10-12 agri finance TEST'
Exo_model <- 'model exo 10-12 agri finance TEST'
...
Model_data_invest <- read_excel("Model_data_invest_IO.xlsx")
...
Model_data_agri_fin_1995 <- read_excel("Model_data_agri_fin_1995.xlsx")
Model_data_agri_fin_1996 <- read_excel("Model_data_agri_fin_1996.xlsx")
...
```{r}
Model_data_forecast_1995 <- read_excel("Model_data_forecast_1995.xlsx")
Model_data_forecast_1996 <- read_excel("Model_data_forecast_1996.xlsx")
...
```{r}
S_modelData_F$S_11_share_1 = TSEXTEND(S_modelData$S_11_share_1,  UPTO=c(2050,1), EXTMODE = "CONSTANT")
```
...
Exo_model$simulation$fnw_nfc - S_modelData_F$fnw_nfc
```
...
plot(TSDELTALOG(Exo_model$simulation$pconk), col= "red", ylab= "B. DKR" , main= "Domestic consumption", lwd=3, xlab="", cex.main=1.8); lines(TSDELTALOG(S_modelData$pcon_2010_pout), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(TSDELTALOG(Exo_model$simulation$yk), col= "red", ylab= "B. DKR" , main= "Real GDP" , lwd=3, xlab="", cex.main=1.8); lines(TSDELTALOG(S_modelData$yk), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid() 


plot(TSDELTALOG(Exo_model$simulation$ik), col= "red", ylab= "B. DKR" , main= "Real Investments" , lwd=3, xlab="", cex.main=1.8); lines(TSDELTALOG(S_modelData$inv_2010_pout), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(TSDELTALOG(Exo_model$simulation$xk), col= "red", ylab= "B. DKR" , main= "Real export" , lwd=3, xlab="", cex.main=1.8); lines(TSDELTALOG(S_modelData$ex_2010_pout), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(TSDELTALOG(Exo_model$simulation$imk), col= "red", ylab= "B. DKR" , main= "Real imports" , lwd=3, xlab="", cex.main=1.8); lines(TSDELTALOG(S_modelData$imk), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(TSDELTALOG(Exo_model$simulation$emp_tot), col= "red", ylab= "1000 people" , main= "employment" , lwd=3, xlab="", cex.main=1.8); 
lines(TSDELTALOG(S_modelData$emp_tot), col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); 
grid()
...
plot(Exo_model$simulation$pcon, col= "red", ylab= "B. DKR" , main= "Domestic consumption", lwd=3, xlab="", cex.main=1.8); lines(S_modelData$pcon, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$y, col= "red", ylab= "B. DKR" , main= "GDP" , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$y, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid() 


plot(Exo_model$simulation$i, col= "red", ylab= "B. DKR" , main= "Investments" , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$i, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$x, col= "red", ylab= "B. DKR" , main= "Export" , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$x, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$im, col= "red", ylab= "B. DKR" , main= "Imports" , lwd=3, xlab="", cex.main=1.8); lines(S_modelData$im, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
# Adding a collective title for both plots
mtext("Nominal aggregate variables", side = 3, outer = TRUE, line = 1, cex = 1.5)
...
plot(Exo_model$simulation$pout_1, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$pout_1, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_2, col= "red", ylab= "B. DKR" , main= "Meat and Fish production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_2, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("bottomleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_3, col= "red", ylab= "B. DKR" , main= "Dairy production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_3, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_4, col= "red", ylab= "B. DKR" , main= "Bread production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_4, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_5, col= "red", ylab= "B. DKR" , main= "Other food production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_5, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_6, col= "red", ylab= "B. DKR" , main= "Other manufacturing", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_6, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_7, col= "red", ylab= "B. DKR" , main= "Energy production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_7, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_8, col= "red", ylab= "B. DKR" , main= "Financial corporations", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_8, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("bottomleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$pout_9, col= "red", ylab= "B. DKR" , main= "Other industries", lwd=3, xlab="" , cex.main=2); lines(S_modelData$pout_9, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
plot(Exo_model$simulation$market_share_1, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$market_share_1, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_2, col= "red", ylab= "B. DKR" , main= "Meat and Fish production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_2, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("bottomleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_3, col= "red", ylab= "B. DKR" , main= "Dairy production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_3, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_4, col= "red", ylab= "B. DKR" , main= "Bread production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_4, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_5, col= "red", ylab= "B. DKR" , main= "Other food production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_5, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_6, col= "red", ylab= "B. DKR" , main= "Other manufacturing", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_6, col = "blue", lwd=3, xlab=""); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_7, col= "red", ylab= "B. DKR" , main= "Energy production", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_7, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_8, col= "red", ylab= "B. DKR" , main= "Financial corporations", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_8, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("bottomleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$market_share_9, col= "red", ylab= "B. DKR" , main= "Other industries", lwd=3, xlab="" , cex.main=2); lines(S_modelData$market_share_9, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
...
plot(Exo_model$simulation$fnw_nfc, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$fnw_nfc, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$nint_agri, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$nint_agri, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()

plot(Exo_model$simulation$y_agri, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$y_agri, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()


plot(Exo_model$simulation$s_agri, col= "red", ylab= "B. DKR" , main= "Agriculture/Forresty/Fishery", lwd=3, xlab=""  , cex.main=2); lines(S_modelData$s_agri, col = "blue", lwd=3, xlab="",cex = 1.5); 
legend("topleft",legend=c("Model (baseline)", "Data"),lty=c(1,1),lwd=c(2),bty="n", col = c("red", "blue"), cex=2); grid()
